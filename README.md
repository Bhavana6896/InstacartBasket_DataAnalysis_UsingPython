# InstacartBasket_DataAnalysis_UsingPython
Python-based behavioral analytics across 32.4M transactions to identify high-value customer segments and optimize marketing allocation for an online grocery platform, Instacart.
...
Objective: This analysis derives insights into customer buying habits to enable Instacart to customize their marketing campaigns to more effectively target customer profiles, enhance the relevancy of promotions and ads, and boost sales.
